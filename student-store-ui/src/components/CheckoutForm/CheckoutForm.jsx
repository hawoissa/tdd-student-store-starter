     ...
     <div className="checkout-form">
      <div className="content">
         ...
         <div className="input" id="name">
            <p>Name</p>
            <input className="checkout-form-input" type="name" name="name"  id="name" value={props.checkoutForm.name} 
         ...
         <div className="input" id="email">
            <p>Email</p>
            <input className="checkout-form-input" type="email" name="email"  id="email" value={props.checkoutForm.email} 
